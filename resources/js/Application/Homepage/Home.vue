    ...
    <layout header-title="Home" :header-url="$page.props.saas_url + '/'">
        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
            <a
                ...
                target="_blank"
                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#0EA5E9] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#0EA5E9]"
            >
                <div
                    class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#0EA5E9]/10 sm:size-16"
                >
                <svg
                ...
                <svg
                    class="size-6 shrink-0 self-center stroke-[#0EA5E9]"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
                ...
                <div class="pt-3 sm:pt-5">
                    ...
                    <p class="mt-4 text-sm/relaxed">
                        ...
                        <a
                            ...
                            class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#0EA5E9] dark:hover:text-white dark:focus-visible:ring-[#0EA5E9]"
                            >Forge</a
                        >,
                        <a
                            href="https://vapor.laravel.com"
                            class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#0EA5E9] dark:hover:text-white"
                            >Vapor</a
                        >,
                        <a
